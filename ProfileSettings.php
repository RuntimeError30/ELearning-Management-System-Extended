...
if (isset($_POST["generelBtn"])) {
    $Mobile = $_POST['Mobile'];
    $updateQuery = mysqli_query($conn, "UPDATE logininfo SET `Mobile Number` = '$Mobile' WHERE StudentID = '$StudentID'");
}
...
if (isset($_POST["PasswordChange"])) {
    ...
    if(($Password==$OldPass) && ($NewPassword == $ReTypeNewPassword)){
        $updateQuery = mysqli_query($conn, "UPDATE logininfo SET `Password` = '$NewPassword' WHERE StudentID = '$StudentID'");
    }
...
if (isset($_POST["ProfilePic"])) {
    ...
    if (empty($row['profilePictureSection'])) {
        ...
        $insertQuery = mysqli_query($conn, "UPDATE logininfo SET profilePictureSection = '$propicPath' WHERE StudentID = '$StudentID'");
    } else {

        $updateQuery = mysqli_query($conn, "UPDATE logininfo SET profilePictureSection = '$propicPath' WHERE StudentID = '$StudentID'");
    }
                                    ...
                                    <form action="propicChange.php" method="post">
                                            ...
                                            <?php
                                                if ($row["profilePictureSection"] != null) {
                                                    ...
                                                    echo '<img src="' . $row["profilePictureSection"] . '" alt="Profile Picture" class="w-72 rounded-xl">';
                                                } else {
                                ...
                                <form action="" method="post" >
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="w-full mr-5 mt-5 ">
                                            <label for="" class="text-gray-900">Student Name</label>
                                            <input type="text" name="Stdname" id="" placeholder="<?php echo $row["StudentName"]; ?>" class=" w-full p-3 border border-orange-500  rounded-xl bg-transparent" disabled >
                                        </div>


                                        <div class="w-full mr-5 mt-5 ">
                                            <label for="" class="text-gray-900">Student ID</label>
                                            <input type="text" name="ID" id="" placeholder="<?php echo $row["StudentID"]; ?>" class=" w-full p-3 border border-orange-500  rounded-xl bg-transparent" disabled >
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="w-full mr-5 mt-5 ">
                                            ...
                                            <input type="text" name="Mobile" id="" placeholder="<?php echo $row["Mobile Number"]; ?>" class="text-gray-950 w-full p-3 border border-orange-500  rounded-xl bg-transparent" >
                                        </div>
                                    </div>
