            ...
            <div class=" ml-10 h-full w-full mr-10">
                <div class="flex justify-between mt-10 p-5  rounded-2xl h-fit w-full" style="background: #00000090">
                    ...
                    <div class="flex">
                        ...
                        <a href="TeachersSettings.php" class="mr-10 mt-11">
                ...
                <div class="fixed flex w-full h-full overflow-scroll">
                    <div class=" overflow-scroll mt-20 p-5 rounded-2xl h-5/6 w-1/2 bg-[#00000090]">
                        ...
                        <?php
                            ...
                            $query1 = "SELECT * FROM facultycoursetab WHERE FacultyID ='$facID' ";
                            $r = $conn->query($query1);
                            ...
                            <div class="border border-[#E55523]  w-full  shadow-2xl mt-5  h-fit p-5 rounded-xl" style="background: #00000090;">
                                <a href="courseDetailsTeacher.php?coursename=<?php echo urlencode($CourseRow["CourseName"]); ?>&trimester=<?php echo urlencode($CourseRow["Trimester"]); ?>&coursecode=<?php echo urlencode($CourseRow["CourseCode"]);?>&section=<?php echo urlencode($CourseRow["Section"]); ?>&Department=<?php echo urlencode($CourseRow["Department"]);?>" class="w-full">
                                    <div class="">
                        ...
                        <div class="w-full h-fit p-5 rounded-2xl  bg-[#00000090] mb-6"  >
                            ...
                            <div class="flex justify-between pl-5">
                                <div class="mt-20">
                                    ...
                                    <h1 class="text-xs "><?php echo $row["ID"]; ?></h1>
                                    <h1 class="text-xs uppercase mt-2">Department of <?php echo $row["Department"]; ?></h1>
                                    <h1 class="text-xs uppercase mt-2"> <?php echo $row["Email"]; ?></h1>
